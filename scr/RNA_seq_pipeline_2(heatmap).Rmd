...
all_bam_file <-list.files(path =  "C:/Users/xinyi7/Dropbox/emily R")
all_bam_file= sapply(all_bam_file,function(x)  {paste0("C:/Users/xinyi7/Dropbox/emily R/",x)})
## check proporation of mapping
## this step takes a lot of time
propmapped(all_bam_file)

## counts read from all .bam files, which are all using hg19 annotation (same as the reference genome when alignment)

fc_mm10 <- featureCounts(all_bam_file, annot.inbuilt="mm10", isPairedEnd=FALSE)

save(fc_mm10,file="C:/Users/xinyi7/Dropbox/emily R/read_count_mm10.RData")
